...
class Reservation {
    ...
    public function addReservation($data) {
        $this->db->query('INSERT INTO reservations (id_user, id_establishment, id_suite, start_date, end_date) 
        VALUES (:id_user, :id_establishment, :id_suite, :start_date, :end_date)');
        //Bind values
    ...
    public function selectReservationByUserId($id_user) {
        $this->db->query(
            'SELECT name, title, start_date, end_date FROM reservations
